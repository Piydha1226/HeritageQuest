...
/**
 * Title: More Post
 * Slug: travel-agent-blocks/more-post
 * Categories: travel-agent-blocks, more-post
 */
?>
...
<h3 class="wp-block-heading has-text-align-center"><?php esc_html_e('More Articles &amp; Posts','travel-agent-blocks'); ?></h3>
<!-- /wp:heading -->
