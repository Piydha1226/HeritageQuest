 ...
 * Slug: travel-agent-blocks/single-product
 * Categories: travel-agent-blocks, single-product
 */
?>
...
<h2 class="wp-block-heading has-text-align-left has-large-font-size" style="margin-top:1rem;margin-bottom:1rem"><?php esc_html_e('Related Products','travel-agent-blocks'); ?></h2>
<!-- /wp:heading -->
