...
function travelscape_wte_scripts() {			
	...
	wp_enqueue_style( 'travelscape-wte-style', TRAVELSCAPE_PARENT_URI . '/inc/wte/wte.css', '', TRAVELSCAPE_PARENT_THEME_VERSION );		
	wp_enqueue_script( 'travelscape-wte-script', TRAVELSCAPE_PARENT_URI . '/inc/wte/wte.js', array('jquery'), TRAVELSCAPE_PARENT_THEME_VERSION, true );
