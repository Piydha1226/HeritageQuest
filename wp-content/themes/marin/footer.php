	...
	?>
		...
		">
			...
			if ( function_exists( 'marin_get_social_icon_default' ) ) :
				$marin_footer_social_icons = get_theme_mod( 'marin_topbar_social_icons', marin_get_social_icon_default() );
				else :
					$marin_footer_social_icons = get_theme_mod( 'marin_topbar_social_icons' );
				endif;
											...
											<div class="widget-right">                          
												<?php
													$marin_copyright_allowed_tags = array(
														...
														'[theme_author]' => sprintf( __( '<a href="#" target="_blank"> Marin </a>', 'marin' ) ),
													);
													?>
